<section id="about" class="py-24 bg-slate-900/50">
    <div class="container mx-auto px-6 md:px-12 lg:px-24">
        ...
        <div class="text-center mb-16" data-aos="fade-up">
            <h2 class="text-3xl md:text-4xl font-bold text-white mb-4">About <span class="text-sky-400">Me</span></h2>
        ...
        <div class="flex flex-col md:flex-row items-center gap-12">
            ...
            <div class="w-full md:w-1/2 space-y-6" data-aos="fade-left">
                <h3 class="text-2xl font-semibold text-slate-200">{{ $user->about_title }}</h3>
                <p class="text-slate-400 leading-relaxed text-lg whitespace-pre-line">
                    {{ str_replace('"', ' ', $user->about_description) }}
                </p>
